...
const Form = ({ db, addUser }) => {
  ...
  return (
      ...
      <section className="p-6 dark:bg-gray-800 dark:text-gray-50">
        ...
        >
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
            <div className="space-y-2 col-span-full lg:col-span-1 text-lg">
              <p className="text-2xl">Creación de cuentas</p>
              <p className="font-bold">
                Regístrese y obtenga los mejores beneficios en greydive!</p>
                <p>Luego
                de registrarse, verifique su casilla de correo electrónico para
                confirmar la creación de la cuenta.<br></br> Ante cualquier incoveniente
                puede comunicarse a info@greydive.com.
              </p>
            </div>
            {showModal ? (
        <>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-3xl font-semibold text-gray-900">
                    Redirección a usuarios registrados
                  </h3>
                  <button
                    className="p-1 ml-auto border-0 text-black float-right text-3xl leading-none font-bold outline-none focus:outline-none"
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-gray-900 font-bold text-lg leading-relaxed">
                    Ingresa a la base de datos de usuarios registrados para obtener informacion adicional.
                  </p>
                </div>
          ...
          <div className="opacity-25 fixed inset-0 z-40 bg-black"></div>
            ...
            <div className="grid gap-4 col-span-4 lg:col-span-3">
              {db.map((item, index) => {
                return (
                    ...
                    {item.type === "text" ? (
                      <div className="col-span-full sm:col-span-3">
                        <label key={index}>
                          ...
                          <input
                            ...
                            className="p-1 w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900"
                          />
                        </label>
                      </div>
                    ) : item.type === "email" ? (
                      ...
                      <label key={index}>
                        ...
                        <select
                          ...
                          required={item.required}
                          onChange={handleInputChange}
                          className="p-1 w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-900"
                        >
                      ...
                      <label key={index}>
                        ...
                        <input
                          ...
                          name={item.name}
                          required={item.required}
                          className="rounded-sm ml-3 focus:ring-2"
                        />
                      </label>
                    ) : item.type === "submit" ? (
                      <input
                        ...
                        type="submit"
                        value={item.label}
                        className="px-5 py-2 flex font-semibold rounded-lg dark:bg-gray-100 hover:bg-gray-600 hover:text-white dark:text-gray-800 cursor-pointer"
                      />
                    ) : null}
                  </div>
                );
	...
	<div className="container p-4 mx-auto text-center">
		<h2 className="text-4xl font-bold">Nuestros clientes de confianza</h2>
	</div>
